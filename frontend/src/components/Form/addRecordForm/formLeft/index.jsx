  ...
  return (
    <div className="p-4">
      <div className="flex my-3 rounded-full bg-[#F3F4F6] w-full gap-5 ">
        <button className=" flex-1 btn-md rounded-3xl border-none bg-[#F3F4F6] focus:bg-[#0166FF] focus:text-white h-10">
          Expense{" "}
        </button>
            ...
            <li className="w-full border-b-2">
              <a>
                <button
                  ...
                  className="flex w-full items-center gap-2 font-normal py-3 p-2"
                >
        ...
        <div className="flex">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full input input-bordered h-8 bg-[#F9FAFB]"
            />
          </div>
          <div className="flex-1">
            <label className="label">
            ...
            <input
              type="time"
              placeholder="4:15 PM"
              className="w-full input input-bordered bg-[#F9FAFB] h-8"
            />
          </div>
        </div>
      </form>
      <button
        onClick={closeForm}
        className="btn modal-backdrop bg-[#0166FF] hover:bg-blue-800 w-full font-normal my-4 text-white rounded-full h-10"
      >
        Add Record
      </button>
