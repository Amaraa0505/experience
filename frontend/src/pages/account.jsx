...
export default function account() {
  return (
    <div className="flex h-screen p-10">
      <Records />
      <div className=" w-[1600px] ml-10 rounded-xl p-6">
        <div className="flex ">
        ...
        <div className="bg-white rouned-xl flex rounded-xl h-14 items-center mt-3 gap-[1320px]">
        ...
        <Today />
        <p className="font-bold my-4"> Yesterday</p>
        <Yesterday />
      </div>
    </div>
  );
